...
import com.haifeng.common.core.domain.entity.SysDictType;
...
import com.haifeng.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    public void deleteDictTypeByIds(Long[] dictIds)
    {
        for (Long dictId : dictIds)
        {
            ...
            {
                throw new ServiceException("dict.type.assigned.cannot.delete", dictType.getDictName());
            }
