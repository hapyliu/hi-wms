package com.haifeng.common.utils.poi;
...
import com.haifeng.common.exception.UtilException;
...
import com.haifeng.common.utils.file.FileTypeUtils;
import com.haifeng.common.utils.file.FileUtils;
import com.haifeng.common.utils.file.ImageUtils;
import com.haifeng.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public Cell createHeadCell(Excel attr, Row row, int column)
    {
        ...
        // 写入列信息
        //cell.setCellValue(attr.name());
        cell.setCellValue(MessageUtils.parseMessage(attr.name()));  // 修改后方法
    ...
    {
        String downloadPath = HaifengConfig.getDownloadPath() + filename;
