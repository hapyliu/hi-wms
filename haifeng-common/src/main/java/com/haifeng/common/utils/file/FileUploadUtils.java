package com.haifeng.common.utils.file;
...
import com.haifeng.common.exception.file.FileNameLengthLimitExceededException;
import com.haifeng.common.exception.file.FileSizeLimitExceededException;
import com.haifeng.common.exception.file.InvalidExtensionException;
...
import com.haifeng.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = HaifengConfig.getProfile();
    ...
    {
        int dirLastIndex = HaifengConfig.getProfile().length() + 1;
