...
public class SysDept extends BaseEntity
{
    ...
    @Size(min = 0, max = 30, message = "{dept.name.length.invalid}")
    ...
    @Size(min = 0, max = 11, message = "{dept.phone.length.invalid}")
    ...
    @Size(min = 0, max = 50, message = "{dept.email.length.invalid}")
