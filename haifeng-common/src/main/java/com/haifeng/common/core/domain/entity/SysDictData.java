...
public class SysDictData extends BaseEntity
{
    ...
    /** 国际化标签（不存储到数据库，仅用于返回给前端） */
    private transient String i18nLabel;
    ...
    @NotBlank(message = "{dict.label.not.blank}")
    @Size(min = 0, max = 100, message = "{dict.label.length.invalid}")
    ...
    @NotBlank(message = "{dict.value.not.blank}")
    @Size(min = 0, max = 100, message = "{dict.value.length.invalid}")
    ...
    @Size(min = 0, max = 100, message = "{dict.css.class.length.invalid}")
